...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{1189 1047} {2147 1546}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 158} {height 226} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 288} {height 226} {dock_state left} {dock_on_new_line true} {child_data_colvariable 145} {child_data_colvalue 100} {child_data_coltype 46} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 958} {height 166} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_select -id ${Hier.1} {systolic_array_tb}}
...
gui_list_show_data -id ${Data.1} {systolic_array_tb}
...
gui_open_source -id ${Source.1}  -replace -active systolic_array_tb /nethome/dzuberi3/lab3-files/testbenches/systolic_array_tb.v
